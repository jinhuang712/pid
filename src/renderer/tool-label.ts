 ...
 *   (`<server>_<tool>`) can be recognised and shown as "MCP klook-engine · lookup mysql catalog".
 */
 ...
 * session knows. The longest matching server prefix wins ("klook-engine" over "klook").
 */
