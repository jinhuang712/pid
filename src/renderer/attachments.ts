...
/**
 * Pi expands `/acme-status extra words` into the skill's full SKILL.md before it becomes the user
 * message, so that is all the transcript ever sees. Fold it back: the body is what the user
 * effectively typed (`/acme-status extra words`), the skill text becomes a collapsible chip.
 */
